...
<body>
  <header class="full-width NavBarP">
    ...
    <i class="fa fa-bars visible-xs btn-menuLubile ShowMenuLubile" aria-hidden="true"></i>
  </header>
                ...
                <thead>
                  ...
                  <tr class="row_2">
                    ...
                    <td class="activity activity_8" id="activity_8" style="cursor: pointer;"><img
                        ...
                        data-original-title="Camina" width="25" height="25"></td>
                    ...
                    <td class="specie specie_1" id="specie_1" style="cursor: pointer;"><img
                      src="index_files/ga.png" alt="Halcón de Galápagos" data-toggle="tooltip"
                      data-placement="bottom" title=""
                      data-original-title="Halcón de Galápagos" width="25" height="25"></td>
              <td class="specie specie_2 tour-step15" id="specie_2" style="cursor: pointer;">
                  <img src="index_files/lo.png" alt="Lobo marino de Galápagos"
                      data-toggle="tooltip" data-placement="bottom" title=""
                      data-original-title="Lobo marino de Galápagos" width="25" height="25">
              </td>
              <td class="specie specie_3" id="specie_3" style="cursor: pointer;"><img
                      src="index_files/pa.png" alt="Piquero de patas azules"
                      data-toggle="tooltip" data-placement="bottom" title=""
                      data-original-title="Piquero de patas azules" width="25" height="25">
              </td>
              <td class="specie specie_4" id="specie_4" style="cursor: pointer;"><img
                      src="index_files/fr.png" alt="Fragatas" data-toggle="tooltip"
                      data-placement="bottom" title="" data-original-title="Frigatas"
                      width="25" height="25"></td>
              <td class="specie specie_5" id="specie_5" style="cursor: pointer;"><img
                      src="index_files/to.png" alt="Tortuga gigante de Galápagos"
                      data-toggle="tooltip" data-placement="bottom" title=""
                      data-original-title="Tortuga gigante de Galápagos" width="25"
                      height="25"></td>
              <td class="specie specie_7" id="specie_7" style="cursor: pointer;"><img
                      src="index_files/im.png" alt="Iguana marina" data-toggle="tooltip"
                      data-placement="bottom" title="" data-original-title="Iguana marina"
                      width="25" height="25"></td>
              <td class="specie specie_8" id="specie_8" style="cursor: pointer;"><img
                      src="index_files/pn.png" alt="Piquero de Nazca" data-toggle="tooltip"
                      data-placement="bottom" title="" data-original-title="Piquero de Nazca"
                      width="25" height="25"></td>
              <td class="specie specie_6" id="specie_6" style="cursor: pointer;"><img
                      src="index_files/fla.png" alt="Flamenco americano" data-toggle="tooltip"
                      data-placement="bottom" title=""
                      data-original-title="Flamenco americano" width="25" height="25"></td>
              <td class="specie specie_11" id="specie_11" style="cursor: pointer;"><img
                      src="index_files/pe.png" alt="Lobo peletero" data-toggle="tooltip"
                      data-placement="bottom" title="" data-original-title="Lobo peletero"
                      width="25" height="25"></td>
              <td class="specie specie_9" id="specie_9" style="cursor: pointer;"><img
                      src="index_files/u.png" alt="Pingüino de Galápagos"
                      data-toggle="tooltip" data-placement="bottom" title=""
                      data-original-title="Pingüino de Galápagos" width="25" height="25"></td>
              <td class="specie specie_12" id="specie_12" style="cursor: pointer;"><img
                      src="index_files/pr.png" alt="Piquero de patas rojas"
                      data-toggle="tooltip" data-placement="bottom" title=""
                      data-original-title="Piquero de patas rojas" width="25" height="25">
              </td>
              <td class="specie specie_10" id="specie_10" style="cursor: pointer;"><img
                      src="index_files/it.png" alt="Iguana terrestre" data-toggle="tooltip"
                      data-placement="bottom" title="" data-original-title="Iguana terrestre"
                      width="25" height="25"></td>
              <td class="specie specie_13" id="specie_13" style="cursor: pointer;"><img
                      src="index_files/alb.png" alt="Albatros de Galápagos"
                      data-toggle="tooltip" data-placement="bottom" title=""
                      data-original-title="Albatros de Galápagos" width="25" height="25"></td>
              <td class="specie specie_14" id="specie_14" style="cursor: pointer;"><img
                      src="index_files/co.png" alt="Cormorán" data-toggle="tooltip"
                      data-placement="bottom" title="" data-original-title="Cormorán"
                      width="25" height="25"></td>
              <td class="specie specie_15" id="specie_15" style="cursor: pointer;"><img
                      src="index_files/is.png" alt="Iguana de Santa Fé" data-toggle="tooltip"
                      data-placement="bottom" title=""
            ...
            tivity Codes -->
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td id="visit_point_2" class="isle_2 visit_point_2 visit_point" style="cursor: pointer;"> Playa
                      Bartolomé
                    </td>
                    ...
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <td style="font-size: 11px; text-align: center" class="isle_2 visit_point_2 ship_2 route_4"> 5-D3Mi
                    </td>
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <td style="font-size: 11px; text-align: center" class=""></td>
                  ...
                  <tr>
                    ...
                    <td style="text-align: center" class="isle_2 visit_point_37 specie_1  specie_4  specie_9"> 3
                    </td>
                    <!-- count Species per Viesit Point-->
                  ...
                  <tr>
                    ...
                    <td id="visit_point_3" class="isle_3 visit_point_3 visit_point" style="cursor: pointer;"> Bahía
                      Gardner
                    </td>
                    <!-- Isle -->
                    <!-- Viesit Point -->
                    ...
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <td style="font-size: 11px; text-align: center" class="isle_3 visit_point_3 ship_1 route_2"> 14-D5Ma
                    </td>
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    ...
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <td style="font-size: 11px; text-align: center" class="isle_3 visit_point_3 ship_3 route_9"> 7-D3Do
                    </td>
                    <!-- Activities -->
                    <!-- Routes -->
                    <!-- Routes -->
                  ...
                  <tr>
                    <td id="visit_point_4" class="isle_3 visit_point_4 visit_point" style="cursor: pointer;"> Islote
                      Osborn
                    </td>
                    <!-- Viesit Point -->
                    ...
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <td style="font-size: 11px; text-align: center" class="isle_3 visit_point_4 ship_3 route_9">8-D3Do
                    </td>
                    <!-- Activities -->
                    <!-- Routes -->
                    <!-- Routes -->
                  ...
                  <tr>
                    ...
                    <td style="font-size: 11px; text-align: center" class="isle_3 visit_point_5 ship_1 route_2"> 13-D5Ma
                    </td>
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <td style="font-size: 11px; text-align: center" class="isle_3 visit_point_5 ship_2 route_6"> 9-D4Do
                    </td>
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <td style="font-size: 11px; text-align: center" class=""></td>
                  ...
                  <tr>
                    <td id="visit_point_31" class="isle_3 visit_point_31 visit_point" style="cursor: pointer;"> Islote
                      Gardner </td>
                    <!-- Viesit Point -->
                    ...
                    <td style="text-align: center"
                      class="isle_3 visit_point_31 specie_1 specie_3  specie_8 activity_4 activity_1 activity_3 specie_13">
                      4
                    </td>
                    <!-- count Species per Viesit Point-->
                  ...
                  <tr>
                    ...
                    <td id="visit_point_7" class="isle_5 visit_point_7 visit_point" style="cursor: pointer;"> Torre de
                      la Baronesa </td>
                    <!-- Isle -->
                    <!-- Viesit Point -->
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    ...
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <!-- Routes -->
                    <td style="font-size: 11px; text-align: center" class="isle_5 visit_point_7 ship_2 route_5">14-D6Mi
                    </td>
                    <!-- Routes -->
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <!-- Routes -->
                  ...
                  <tr>
                    <td id="visit_point_8" class="isle_5 visit_point_8 visit_point" style="cursor: pointer;">Muelle de
                      la oficina de correos</td>
                    <!-- Viesit Point -->
                    ...
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <td style="font-size: 11px; text-align: center" class="isle_5 visit_point_8 ship_1 route_3"> 9-D4Do
                    </td>
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <td style="font-size: 11px; text-align: center" class="isle_5 visit_point_8 ship_2 route_5"> 12-D6Mi
                    </td>
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <td style="font-size: 11px; text-align: center" class=""></td>
                  ...
                  <tr>
                    <td id="visit_point_9" class="isle_5 visit_point_9 visit_point" style="cursor: pointer;">Islote
                      Champiñón</td>
                    <!-- Viesit Point -->
                  ...
                  <tr>
                    ...
                    <td id="visit_point_10" class="isle_6 visit_point_10 visit_point" style="cursor: pointer;"> Bahía
                      Darwin
                    </td>
                    <!-- Isle -->
                    <!-- Viesit Point -->
                    ...
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <td style="font-size: 11px; text-align: center" class="isle_6 visit_point_10 ship_3 route_8"> 6-D3Mi
                    </td>
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <!-- Activities -->
                    <!-- Routes -->
                  ...
                  <tr>
                    <td id="visit_point_11" class="isle_6 visit_point_11 visit_point" style="cursor: pointer;"> Pasos
                      del Príncipe Philips </td>
                    <!-- Viesit Point -->
                    <td style="text-align: center" class=""><span class="">&nbsp; </span> </td>
                    ...
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <td style="font-size: 11px; text-align: center" class="isle_6 visit_point_11 ship_3 route_8"> 7-D3Mi
                    </td>
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <!-- Activities -->
                    <!-- Routes -->
                  ...
                  <tr>
                    ...
                    <td id="visit_point_12" class="isle_7 visit_point_12 visit_point" style="cursor: pointer;"> Bahía
                      Urbina </td>
                    <!-- Isle -->
                    <!-- Viesit Point -->
                    <td style="font-size: 11px; text-align: center" class=""></td>
                  ...
                  <tr>
                    <td id="visit_point_13" class="isle_7 visit_point_13 visit_point" style="cursor: pointer;"> Caleta
                      del Tajo </td>
                    <!-- Viesit Point -->
                  ...
                  <tr>
                    <td id="isle_9" class="isle isle_9" style="cursor: pointer;"> Sur Plaza </td>
                    <td id="visit_point_16" class="isle_9 visit_point_16 visit_point" style="cursor: pointer;"> Sur
                      Plaza </td>
                    <!-- Isle -->
                    <!-- Viesit Point -->
                    <td style="font-size: 11px; text-align: center" class=""></td>
                  ...
                  <tr>
                    ...
                    <td id="visit_point_17" class="isle_10 visit_point_17 visit_point" style="cursor: pointer;"> Playa
                      Roja </td>
                    <!-- Isle -->
                    <!-- Viesit Point -->
                  ...
                  <tr>
                    <td id="visit_point_20" class="isle_11 visit_point_20 visit_point" style="cursor: pointer;"> Centro
                      de cría de tortugas</td>
                    <!-- Viesit Point -->
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <td style="text-align: center" class="&gt;
																		&lt;span class=" fa="" fa-check"="">&nbsp;</td>
                  ...
                  <tr>
                    <td id="visit_point_21" class="isle_11 visit_point_21 visit_point" style="cursor: pointer;"> Islote
                      Pitt </td>
                    <!-- Viesit Point -->
                    <td style="text-align: center" class=""><span class="">&nbsp; </span></td>
                    <!-- Activities -->
                  ...
                  <tr>
                    <td id="visit_point_40" class="isle_11 visit_point_40 visit_point" style="cursor: pointer;"> Loberia
                    </td>
                    <!-- Viesit Point -->
                  ...
                  <tr>
                    <td id="visit_point_44" class="isle_11 visit_point_44 visit_point" style="cursor: pointer;"> Paseo
                      de la ciudad </td>
                    <!-- Viesit Point -->
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <td style="text-align: center" class=""><span class="">&nbsp; </span></td>
                  ...
                  <tr class="d-none">
                    ...
                    <!-- Species -->
                    <td style="text-align: center"
                      class="isle_12 visit_point_24 specie_4 activity_5 activity_7 activity_8"><span
                        class="fa fa-check">&nbsp;</span></td>
                    <!-- Species -->
                    <td style="text-align: center" class=""></td>
                    <!-- Species -->
                    ...
                    <td style="text-align: center"
                      class="isle_12 visit_point_24 specie_4 activity_5 activity_7 activity_8"> 1 </td>
                    <!-- count Species per Viesit Point-->

                  </tr>
                  <tr>
                    <td id="visit_point_25" class="isle_12 visit_point_25 visit_point" style="cursor: pointer;"> Bahía
                      Tortuga
                    </td>
                    <!-- Viesit Point -->
                  ...
                  <tr>
                    <td id="visit_point_28" class="isle_12 visit_point_28 visit_point" style="cursor: pointer;"> Colina
                      del Dragón </td>
                    <!-- Viesit Point -->
                  ...
                  <tr>
                    <td id="visit_point_30" class="isle_12 visit_point_30 visit_point" style="cursor: pointer;"> Reserva
                      de tortugas gigantes </td>
                    <!-- Viesit Point -->
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <td style="text-align: center" class="&gt;
																		&lt;span class=" fa="" fa-check"="">&nbsp;</td>
                  ...
                  <tr>
                    <td rowspan="" id="visit_point_42" class="isle_12 visit_point_42 visit_point"
                      style="cursor: pointer;"> Paseo de la ciudad </td>
                    <!-- Viesit Point -->
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <td style="text-align: center" class="&gt;
																		&lt;span class=" fa="" fa-check"="">&nbsp;</td>
                  ...
                  <tr>
                    <td id="isle_17" class="isle isle_17" style="cursor: pointer;"> Islote Enden </td>
                  ...
                  <tr>
                    ...
                    <td style="text-align: center" class="isle_13 visit_point_22 activity_8"><span
                        class="fa fa-check">&nbsp;</span></td>
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <td style="font-size: 11px; text-align: center" class="isle_13 visit_point_22 ship_1 route_4">7-D3Su
                    </td>
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <td style="font-size: 11px; text-align: center" class="">
                    </td>
                  ...
                  <tr>
                    ...
                    <td id="visit_point_32" class="isle_14 visit_point_32 visit_point" style="cursor: pointer;">Bahía
                      Sullivan
                    </td>
                    <!-- Isle -->
                    <!-- Viesit Point -->
                  ...
                  <tr>
                    <td id="visit_point_33" class="isle_14 visit_point_33 visit_point" style="cursor: pointer;"> Caleta
                      de los Bucaneros </td>
                    <!-- Viesit Point -->
                    ...
                    <td style="font-size: 11px; text-align: center" class="isle_14 visit_point_33 ship_3 route_8">
                      8-D3Sa</td>
                    <td style="font-size: 11px; text-align: center" class=""></td>
                    <!-- Activities -->
                    <!-- Routes -->
                  ...
                  <tr>
                    ...
                    <td id="visit_point_35" class="isle_15 visit_point_35 visit_point" style="cursor: pointer;"> Norte
                      Seymour </td>
                    <!-- Isle -->
                    <!-- Viesit Point -->
                    <td style="font-size: 11px; text-align: center" class=""></td>
